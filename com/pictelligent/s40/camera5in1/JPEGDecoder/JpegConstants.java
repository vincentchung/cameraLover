...
public interface JpegConstants {
    ...
    public static final int JPEG_APP3_Marker = (0xff00) | (JPEG_APP0 + 3);
    public static final int JPEG_APP4_Marker = (0xff00) | (JPEG_APP0 + 4);
    public static final int JPEG_APP5_Marker = (0xff00) | (JPEG_APP0 + 5);
    public static final int JPEG_APP6_Marker = (0xff00) | (JPEG_APP0 + 6);
    public static final int JPEG_APP7_Marker = (0xff00) | (JPEG_APP0 + 7);
    public static final int JPEG_APP8_Marker = (0xff00) | (JPEG_APP0 + 8);
    public static final int JPEG_APP9_Marker = (0xff00) | (JPEG_APP0 + 9);
    public static final int JPEG_APP10_Marker = (0xff00) | (JPEG_APP0 + 10);
    public static final int JPEG_APP11_Marker = (0xff00) | (JPEG_APP0 + 11);
    public static final int JPEG_APP12_Marker = (0xff00) | (JPEG_APP0 + 12);
    ...
    public static final int[] MARKERS = new int[]{JPEG_APP0, JPEG_APP0_Marker,
