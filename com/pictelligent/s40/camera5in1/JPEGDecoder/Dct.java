...
public class Dct {
    ...
    public static final float[] dctScalingFactors = {
    ...
    public static final float[] idctScalingFactors = {
    ...
    public static final float A1 = 0.70710677f;
    public static final float A2 = 0.5411961f;
    public static final float A3 = 0.70710677f;
    public static final float A4 = 1.306563f;
    public static final float A5 = 0.38268343f;

    public static final float C2 = 1.847759f;
    public static final float C4 = 1.4142135f;
    public static final float C6 = 0.76536685f;
    public static final float Q = 1.0823922f;
    public static final float R = 2.6131258f;

    public static void scaleQuantizationVector(final float[] vector) {
        for (int x = 0; x < 8; x++) {
            vector[x] *= dctScalingFactors[x];
            //DebugUtil.Log("scaleQuantizationVector["+x+"]:"+vector[x]);
            System.out.println("dctScalingFactors["+x+"]:"+dctScalingFactors[x]);
        }
    }
    ...
    public static void scaleDequantizationVector(final float[] vector) {
        for (int x = 0; x < 8; x++) {
            ...
            DebugUtil.Log("scaleDequantizationVector["+x+"]:"+vector[x]);
            System.out.println("idctScalingFactors["+x+"]:"+idctScalingFactors[x]);
        }
    }
        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                matrix[8 * y + x] *= dctScalingFactors[y]
                        * dctScalingFactors[x];
                System.out.println("scaleQuantizationMatrix["+x+"x"+y+"]:"+(dctScalingFactors[y]* dctScalingFactors[x]));
            }
        }
    }
private static float[][] precalDeqMatix=new float[][]{
	{0.12499999f,0.17337997f,0.16332036f,0.14698444f,0.12499999f,0.09821187f,0.06764951f,0.034487423f},
		{0.17337997f,0.24048492f,0.22653185f,0.20387328f,0.17337997f,0.13622378f,0.09383257f,0.04783543f},
		{0.16332036f,0.22653185f,0.21338834f,0.19204442f,0.16332036f,0.12832f,0.088388346f,0.045059986f},
		{0.14698444f,0.20387328f,0.19204442f,0.17283542f,0.14698444f,0.11548494f,0.079547405f,0.040552918f},
		{0.12499999f,0.17337997f,0.16332036f,0.14698444f,0.12499999f,0.09821187f,0.06764951f,0.034487423f},
		{0.09821187f,0.13622378f,0.12832f,0.11548494f,0.09821187f,0.077164575f,0.05315188f,0.027096596f},
		{0.06764951f,0.09383257f,0.088388346f,0.079547405f,0.06764951f,0.05315188f,0.03661165f,0.018664459f},
		{0.034487423f,0.04783543f,0.045059986f,0.040552918f,0.034487423f,0.027096596f,0.018664459f,0.009515058f}};

public static void scaleDequantizationMatrix(final float[] matrix) {
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                //matrix[8 * y + x] *= idctScalingFactors[y]* idctScalingFactors[x];
                //System.out.println("scaleDequantizationMatrix["+x+"x"+y+"]:"+(idctScalingFactors[y]* idctScalingFactors[x]));
            	matrix[8 * y + x] *=precalDeqMatix[y][x];
            }
        }
    }
    ...
    public static void inverseDCT8x8(final float[] matrix) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            b2 = a2 * C4;
            b5 = a5 * C4;
            System.out.println("tmp4:"+tmp4+",neg_b4:"+neg_b4+",b6:"+b6+",b2:"+b2+",b5:"+b5);
            tmp3 = b6 - a7;
            n0 = tmp3 - b5;
